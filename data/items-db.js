// ============================================================
// NEPHALEM'S CODEX — D4 Item & Game Database
// Season 14: Death Awakening | Lord of Hatred Expansion
// Source: Community loot table spreadsheet (Owen Horton, July 2026)
// ============================================================
// HOW TO ADD ITEMS:
//   Unique items: u(id, name, slot, slotDisplay, class, type, sources[], notes)
//   Use boss ID shortcuts: AN AS BA BI BL BU DU GR HA LZ UR VA
//   b(BOSS_ID) = dedicated boss drop
//   pool()     = General Unique Pool (any boss at low rate; Cube 3-to-1 best)
//   myth()     = Mythic Unique (all Tormented Bosses; Belial best)
// ============================================================

// ── Boss ID aliases ───────────────────────────────────────────
const _BN = {
  andariel:"Echo of Andariel", astaroth:"Astaroth, the Charred Duke",
  bartuc:"Bartuc, Lord of Chaos", "beast-in-ice":"The Beast in Ice",
  belial:"Belial, Lord of Lies", butcher:"The Butcher",
  duriel:"Duriel, King of Maggots", grigoire:"Grigoire, the Galvanic Saint",
  harbinger:"Harbinger of Hatred", "lord-zir":"Lord Zir",
  urivar:"Urivar", varshan:"Echo of Varshan"
};
...
const D4DB = {
  ...
  slotCategoryMap:{
    ...
    amulet:"amulet",offhand:"offhand",ring1:"ring",ring2:"ring",
  ...
  bosses:[
    ...
    {id:"beast-in-ice",name:"The Beast in Ice",            tier:"Initiate", keyMaterial:"Distilled Fear",                          keySource:"Nightmare Dungeons (Tier 30+)",                 mythicChance:false,notes:"Key drops from high-tier Nightmare Dungeons."},
    ...
    {id:"butcher",     name:"The Butcher",                 tier:"Encounter",keyMaterial:"None — spawns randomly",                  keySource:"Spawns randomly in dungeons and The Pit",        mythicChance:false,notes:"⚠️ Cannot be summoned. Farm dungeons/The Pit. He is extremely dangerous — come prepared!"},
  ],

  generalUniquePool:[
    "Azurewrath","Banished Lord's Talisman","Blood-Mad Idol","Crown of Lucion",
    "Endurant Faith","Fists of Fate","Flickerstep","Frostburn","Godslayer Crown",
    "Locran's Talisman","Mother's Embrace","Paingorger's Gauntlets","Penitent Greaves",
    "Rakanoth's Wake","Razorplate","Rustbitten Dirk","Shard of Verathiel","Signet of Pelghain",
    "Soulbrand","Tassets of the Dawning Sky","Temerity","The Butcher's Cleaver",
    "Thousand-Eye Reaver","Thundergod's Blessing","Tibault's Will","Wendigo Brand",
    "Wyrdskin","X'Fal's Corroded Signet","Yen's Blessing"
  ],

  uniques:[
    // ── MYTHICS (all classes via Belial) ──
    ...
    u("nesekem",         "Nesekem, the Herald",          "weapon","Glaive",   "Spiritborn","mythic",[b(BL)]),

    // ── GENERAL POOL (any boss; Cube 3-to-1 recommended) ──
    ...
    u("rustbitten-dirk", "Rustbitten Dirk",              "weapon","Dagger",   "all","unique",[pool(),b(BU)]),
    ...
    u("butchers-cleaver","The Butcher's Cleaver",        "weapon","1H Axe",   "all","unique",[pool(),b(GR)]),
    u("thousand-eye",    "Thousand-Eye Reaver",          "weapon","1H Axe",   "all","unique",[pool(),b(BU)]),
  ...
  // ── ASPECTS placeholder — overwritten by aspects-db.js ────────
  aspects: [],

  cubeRecipes:{
    gearModification:[
      {id:"add-affix",    name:"Add Affix",          icon:"➕",description:"Adds a random affix to an item with fewer than 4 affixes.",         materials:"Primordial Dust + Optional: Tuning Prism",          usesTuningPrisms:true, pro:"Build items from scratch — great for base items with 0–2 affixes.",       tip:"Use a Tuning Prism to steer toward the correct affix category."},
      {id:"focus-reroll", name:"Focus Reroll",       icon:"🎯",description:"Rerolls ONE specific affix of your choice on an item.",              materials:"Primordial Dust + Optional: Tuning Prism",          usesTuningPrisms:true, pro:"Best general-purpose recipe. Keeps good affixes, rerolls bad ones.",      tip:"Most efficient refinement method. Add a Tuning Prism to control affix category."},
      {id:"chaotic-reroll",name:"Chaotic Reroll",    icon:"🎲",description:"Rerolls ALL affixes on an item randomly.",                           materials:"Higher tier Primordial Dust",                        usesTuningPrisms:false,pro:"Nuclear option — use when every affix is bad.",                            tip:"⚠️ Risky! Save this for completely bricked items."},
      {id:"remove-affix", name:"Remove Affix",       icon:"➖",description:"Removes one specific affix you select from an item.",                materials:"Primordial Dust",                                    usesTuningPrisms:false,pro:"Combo: Remove bad affix → Add Affix (with Prism) for targeted replacement.",tip:"Fish for All Resistance: Add Resist twice, remove single Resist (50/50 keep All)."},
      {id:"transfigure",  name:"Transfigure Item",   icon:"🔄",description:"Changes the item type while keeping the same slot.",                 materials:"High tier Primordial Dust + Entropic or Kullean Prism",usesTuningPrisms:true,pro:"Force a specific item base type.",                                         tip:"Kullean/Entropic Prisms control the Transfiguration outcome category."},
      {id:"unique-reroll",name:"Unique Power Reroll",icon:"⚡",description:"Rerolls the value range of a Unique item's special power affix.",   materials:"Boss Trophy (any Lair Boss) + Primordial Dust",     usesTuningPrisms:false,pro:"Push a Unique with a bad power roll to max potential.",                    tip:"Collect Boss Trophies as crafting materials — don't discard them!"},
    ],
    itemTransmutation:[
      {id:"three-to-one",name:"3-to-1 Transmutation",icon:"3️⃣→1️⃣",description:"Converts 3 same-slot items into 1 item of that slot at higher rarity. Common → Unique possible!",materials:"3× same-slot items (any rarity) + Primordial Dust",usesTuningPrisms:false,pro:"Best method for General Pool uniques with no dedicated boss.",tip:"Also great for recycling bricked items."},
      {id:"charm-craft",  name:"Unique Charm Craft", icon:"✨",description:"Crafts a Unique Charm for your charm set.",                          materials:"Horadric Resin + Boss Trophies",                     usesTuningPrisms:false,pro:"Target-craft specific charm powers.",                                      tip:"Horadric Resin = salvage Talisman Charms and Seals. Hoard them!"},
      {id:"reroll-charm", name:"Reroll Set Charm",   icon:"🔁",description:"Rerolls a Set Charm, with a chance to obtain Greater Affixes.",     materials:"Horadric Resin + Primordial Dust",                   usesTuningPrisms:false,pro:"Can grant Greater Affixes on Charms — significant power boost.",             tip:"Do this after securing good base charms to push for GA rolls."},
    ],
  },
  ...
  legendaryWorkflow:[
    ...
    {step:2,icon:"⚗️",name:"Roll Affixes (Horadric Cube)",detail:"Use Add Affix (from scratch) or Focus Reroll (replace bad stats). Add Tuning Prisms to control affix category (Offensive, Defensive, etc.)."},
    {step:3,icon:"📖",name:"Imprint Aspect (Occultist)",  detail:"Aspect must be in your Codex of Power — auto-added when you salvage a Legendary with that aspect at the Blacksmith. Costs gold + Veiled Crystals."},
    ...
    {step:5,icon:"⭐",name:"Masterwork (Blacksmith)",     detail:"MW 12 for max power. Every 4 MW levels, ONE random stat gets a stackable 25% bonus. Use Resplendent Sparks to target your highest-value stat."},
  ],
  ...
  tuningPrisms:[
    ...
    {name:"Entropic Tuning Prism",    controls:"Transfiguration (type A)",  icon:"🌀",examples:"Controls Transfigure recipe outcome — pair with Kullean"},
    {name:"Kullean Tuning Prism",     controls:"Transfiguration (type B)",  icon:"🌀",examples:"Controls Transfigure recipe outcome — pair with Entropic"},
  ],
};
